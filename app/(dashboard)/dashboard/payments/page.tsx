...
export default function PaymentsPage() {
  ...
  const statCards = [
    ...
    { label: 'إجمالي العمليات', value: String(total), color: 'text-[#94A3B8]' },
  ]
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-[#94A3B8]">سجل جميع المدفوعات</p>
      </div>
      ...
      <div className="glass-card p-4 rounded-2xl">
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <select
            ...
            className="bg-[#0A0A0F] border border-[#1F1F2E] rounded-xl py-3 px-4 text-white focus:outline-none focus:border-[#22C55E]/50 sm:w-48"
          >
          ...
          <table className="w-full text-right">
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td colSpan={5} className="p-16 text-center text-[#64748B]">
